...
<head>
<meta charset="UTF-8">
	<title>Dynamic Web Crawler</title>
...
<body>
	<div id="header">
		<div>
			<div id="logo">
				<div
					style="height: auto; align: center; font-size: 30px; color: rgb(255, 229, 204);">Dynamic
					Web Crawler</div>
			</div>
			<ul id="navigation">
			...
			<div>
				<div id="main">
					<div style="width: 900px">
						<div
							style="color: #2a2a2a; font-size: 25px; width: 500px; float: left">User
							Profile</div>
					...
					<div style="width: 900px;">
						<div
							...
							<div
								...
								<form name="fourth" class="snform" id="search-form"
									action="Homepage.jsp" method="post">
<table border="1">
<%
ResultSet rs= Dbconn.getResultFromSqlQuery("select * from user_details where user_email='"+session.getAttribute("UserLoginName")+"'");
if(rs.next())
{
%>
<tr><td><label style="font-size: 22px;">User Name</label></td><td style="padding-left: 10px;"><label style="font-size: 22px;"><%=rs.getString(1) %></label></td></tr>
<tr><td><label style="font-size: 22px;">Last Name</label></td><td  style="padding-left: 10px;"><label style="font-size: 22px;"><%=rs.getString(2) %></label></td></tr>
<tr><td><label style="font-size: 22px;">User Email</label></td><td  style="padding-left: 10px;"><label style="font-size: 22px;"><%=rs.getString(3) %></label></td></tr>
<tr><td><label style="font-size: 22px;">User Contact</label></td><td  style="padding-left: 10px;"><label style="font-size: 22px;"><%=rs.getString(4) %></label></td></tr>

									<%--  <br />
									<label style="font-size: 22px;">User Address</label> <%=rs.getString(2) %><br />
									<label style="font-size: 22px;">User Email</label> <%=rs.getString(3) %></label><br />
									<label style="font-size: 22px;">User Mobile</label> <%=rs.getString(4) %></label><br /> --%>
									
									</table><br/>
									<div style="padding-left: 100px; align: left";>
										<button class="search_btn">Back</button>
									</div>
									<%
}
									%>
