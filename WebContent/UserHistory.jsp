			...
			<div>
				<div id="main">
					<div style="width: 900px">
						<div
							style="color: #2a2a2a; font-size: 25px; width: 500px; float: left">Admin
							Homepage</div>
							...
							<div
								...
								<table border="1">
									<tr>
										...
										<th style="padding-left: 10px; padding-right: 10px;">Display</th>

									</tr>
									<%
										ResultSet rs = Dbconn.getResultFromSqlQuery("select distinct keyword,poi from userhistory where user='"
												+ session.getAttribute("UserLoginName") + "'");

										while (rs.next()) {
											String senditem = rs.getString(2) +"@@" + rs.getString(1);
									%>
									<tr>

										<td style="padding-left: 10px;"><%=rs.getString(1)%> <br />
										</td>
										<td style="padding-left: 10px;"><%=rs.getString(2)%></td>
										<td style="padding-left: 10px;"><a
											href="displayhistory?u=<%=senditem%>">Display</a></td>
										<%
											}
										%>
