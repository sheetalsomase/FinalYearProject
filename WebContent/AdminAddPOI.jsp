...
%>
							...
							<div
								...
								<form name="second" class="snform" id="login-form"
									action="AddPoi" method="post">

<strong>	Existing POI</strong><br/>
									<%
											ResultSet rsPoi=Dbconn.getResultFromSqlQuery("select * from poi_user");
											while(rsPoi.next())
											{
												%>
											<label class="req label"><%=rsPoi.getString(1) %></label><br /> 	
												<%
											}
									...
									<label class="req label">POI For Add</label><br /> <input
										type="text" class="stext bgm" id="logemail" name="poi"
										value="" placeholder="Add POI" onfocus="true" /><br /> 
									<div align="left">
										<button class="search_btn">Add POI</button>
