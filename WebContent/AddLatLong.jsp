						...
						<div
							...
							<div
								...
								<form name="SearchForm" class="snform" id="login-form"
									action="addLatLng" method="post">
									<input type="hidden" name="skeyword" value="<%= request.getParameter("skeyword") %>">
									<table>
									<%
									...
									while(rs.next())
									{
										%>
										<tr>
										<td><label><%=rs.getString("locationname") %></label></td><td> <input type="text" name="lat<%=i %>" /></td><td> <input type="text" name="lng<%=i %>" /></td>
										</tr>
										<%
										i++;
									}
									%>
															...
															<br /> <br />
									<div align="left">
										<button class="search_btn">Add LatLng</button>
